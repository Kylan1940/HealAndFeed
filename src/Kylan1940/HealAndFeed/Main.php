  ...
  public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool{
    ...
    $prefix = $this->getConfig()->get(self::PREFIX);
        if($sender instanceof Player){
            ...
            if($cmd->getName() == "heal"){
                  if ($sender -> hasPermission("healandfeed-heal.command")) {
                    if (isset($args[0])){
                       if ($sender -> hasPermission("healandfeed-healother.command")) {
                        ...
                        $sender->sendMessage($prefix.$this->getConfig()->getNested('no-permission.heal.other'));
                       }
                   } 
                   if (!isset($args[0])){
                    ...
                    $sender->sendMessage($prefix.$this->getConfig()->getNested('no-permission.heal.self'));
                  }
                }
                if($cmd->getName() == "healall"){
                  if ($sender -> hasPermission("healandfeed-healall.command")) {
                    ...
                    $sender->sendMessage($prefix.$this->getConfig()->getNested('no-permission.heal.all'));
                  }
                }
                if($cmd->getName() == "feed"){
                  if ($sender -> hasPermission("healandfeed-heal.command")) {
                    if (isset($args[0])){
                      if ($sender -> hasPermission("healandfeed-feedother.command")) {
                        ...
                        $sender->sendMessage($prefix.$this->getConfig()->getNested('no-permission.feed.other'));
                      }
                   } 
                   if(!isset($args[0])){
                    ...
                    $sender->sendMessage($prefix.$this->getConfig()->getNested('no-permission.feedself'));
                  }
                }
                if($cmd->getName() == "feedall"){
                  if ($sender -> hasPermission("healandfeed-feedall.command")) {
                    ...
                    $sender->sendMessage($prefix.$this->getConfig()->getNested('no-permission.feed.all'));
                  }
                }
          ...
          // If use money
          elseif($this->getConfig()->getNested('use') == "money"){
